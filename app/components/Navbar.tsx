...
export default function Navbar() {
    return (
        <div className="font-serif w-full bg-yellow-900 text-orange-50 px-8 py-4 xl:py-6 xl:px-16 text-center sm:flex sm:justify-between sm:items-center rounded shadow">
